...
<div class="box">
  ...
  <div class="content">
    ...
    <ul>
         <li>Do you need more HTML Areas?</li>
         <li>Do you want to add custom CSS code along with the module (to style either the custom HTML or some other store item)?</li>
         <li>Do you just want to add a custom message on the store and need a predefined coloured box style for it?</li>
    </ul>
    <b>If you answer yes to any of the above questions, you need CR2 HTML Module Pro!</b><br /><br />
    PRO Features:
    <ul>
    ...
    or <a href="http://www.opencart.com/index.php?route=extension/extension/info&extension_id=2401" target="_blank">get the PRO version</a> now!</b>
    <br /><br /><br /><br />
    </div><!--area4-->
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="cr2htmlmodule_module[<?php echo $module_row; ?>][position]">
                ...
                <?php } ?>
                <?php if ($module['position'] == 'content_social') { ?>
                <option value="content_social" selected="selected"><?php echo $text_content_social; ?></option>
                <?php } else { ?>
                <option value="content_social"><?php echo $text_content_social; ?></option>
                <?php } ?>
...
function addModule() {
	...
	html += '      <option value="content_social"><?php echo $text_content_social; ?></option>';
